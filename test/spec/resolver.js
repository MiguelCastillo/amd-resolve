...
describe("Resolver Test Suite", function() {
  ...
  describe("When resolving with `baseUrl`", function() {
    ...
    describe("when resolving `./style/application.css` with baseUrl `http://localhost:8015/main.js`", function() {
      beforeEach(function() {
        result = resolver.resolve("./style/application.css", "http://localhost:8015/main.js");
      });

      it("then `url.href` equals `http://localhost:8015/style/application.css.js`", function() {
        expect(result.url.href).to.equal("http://localhost:8015/style/application.css.js");
      });
    });
  });
