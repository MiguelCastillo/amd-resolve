...
!function(){"use strict";function e(e){this.settings=e||{};var s=this.settings.baseUrl||(this.settings.baseUrl="");s&&"/"!==s[s.length-1]&&(this.settings.baseUrl=s+"/")}var s=require("./file"),t=require("./url");e.prototype.resolve=function(t,i){var r,n,a,o,l,u,p,h,g=this.settings,c=g.urlArgs,f=g.shim||{},m=g.packages||[],b=g.paths||{},U=b[t],v=t.split("!");for(t=v.pop(),l=t.replace(/[\/\\]+/g,"/").split("/"),u=l.shift(),p=l.join("/"),r=0,n=m.length;n>r;r++){if(o=m[r],o===u){U=u+"/main";break}if(o.name===u){U=o.location?o.location+"/":"",U+=u+"/"+(p||o.main||"main");break}}return f.hasOwnProperty(t)&&(h={name:f[t].exports||f[t].name||t,deps:f[t].imports||f[t].deps||[]}),U||(U=t),0===v.length&&/\.js$/.test(U)===!1&&(U+=".js"),i=e.useBase(U)&&i?i:g.baseUrl,a=new s(c?U+"?"+c:U,i),{name:t,file:a,url:a.url,shim:h,plugins:v}},e.useBase=function(s){return"."===s[0]&&("/"===s[1]||"."===s[1]&&"/"===s[2])||e.hasProtocol(s)},e.hasProtocol=function(e){return/^(?:(https?|file)(:\/\/\/?))/g.test(e)},e.File=s,e.URL=t,module.exports=e}();
