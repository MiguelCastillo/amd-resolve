...
!function(){"use strict";function e(e){this.settings=e||{};var s=this.settings.baseUrl||(this.settings.baseUrl="");s&&"/"!==s[s.length-1]&&(this.settings.baseUrl=s+"/")}var s=require("./file"),t=require("./url");e.prototype.resolve=function(t,i){var n,r,a,o,l,p,u,h,g=this.settings,c=g.urlArgs,f=g.shim||{},m=g.packages||[],b=g.paths||{},U=b[t],v=t.split("!");for(t=v.pop(),l=t.replace(/[\/\\]+/g,"/").split("/"),p=l.shift(),u=l.join("/"),n=0,r=m.length;r>n;n++){if(o=m[n],o===p){U=p+"/main";break}if(o.name===p){U=o.location?o.location+"/":"",U+=p+"/"+(u||o.main||"main");break}}return f.hasOwnProperty(t)&&(h={name:f[t].exports||f[t].name||t,deps:f[t].imports||f[t].deps||[]}),U||(U=t),0===v.length&&/\.js$/.test(U)===!1&&(U+=".js"),i=e.useBase(U)&&i?i:g.baseUrl,a=new s(c?U+"?"+c:U,i),{name:t,file:a,shim:h,plugins:v}},e.useBase=function(s){return"."===s[0]&&("/"===s[1]||"."===s[1]&&"/"===s[2])||e.hasProtocol(s)},e.hasProtocol=function(e){return/^(?:(https?|file)(:\/\/\/?))/g.test(e)},e.File=s,e.URL=t,module.exports=e}();
