...
!function(){"use strict";function e(e){this.settings=e||{};var s=this.settings.baseUrl||(this.settings.baseUrl="");s&&"/"!==s[s.length-1]&&(this.settings.baseUrl=s+"/")}var s=require("./file"),t=require("./url");e.prototype.resolve=function(t,i){var n,r,a,o,l,p,u,h,c=this.settings,f=c.urlArgs,g=c.shim||{},m=c.packages||[],b=c.paths||{},d=b[t],U=t.split("!");for(t=U.pop(),l=t.replace(/[\/\\]+/g,"/").split("/"),p=l.shift(),u=l.join("/"),n=0,r=m.length;r>n;n++){if(o=m[n],o===p){d=p+"/main";break}if(o.name===p){d=o.location?o.location+"/":"",d+=p+"/"+(u||o.main||"main");break}}return g.hasOwnProperty(t)&&(h={name:g[t].exports||g[t].name||t,deps:g[t].imports||g[t].deps||[]}),d||(d=t),d=s.addExtension(d,"js"),i=e.useBase(d)&&i?i:c.baseUrl,a=new s(f?d+"?"+f:d,i),{name:t,file:a,shim:h,plugins:U}},e.useBase=function(s){return"."===s[0]&&("/"===s[1]||"."===s[1]&&"/"===s[2])||e.hasProtocol(s)},e.hasProtocol=function(e){return/^(?:(https?|file)(:\/\/\/?))/g.test(e)},e.File=s,e.URL=t,module.exports=e}();
