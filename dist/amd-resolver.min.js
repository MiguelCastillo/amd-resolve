...
!function(){"use strict";function s(s){this.settings=s||{};var e=this.settings.baseUrl||(this.settings.baseUrl="");e&&"/"!==e[e.length-1]&&(this.settings.baseUrl=e+"/")}var e=require("./file"),t=require("./url");s.prototype.resolve=function(t,i){var r,n,a,o,l,p,u,h,g=this.settings,c=g.urlArgs,f=g.shim||{},m=g.packages||[],b=g.paths&&g.paths[t]||t,d=t.split("!");for(t=d.pop(),l=t.replace(/[\/\\]+/g,"/").split("/"),p=l.shift(),u=l.join("/"),r=0,n=m.length;n>r;r++){if(o=m[r],o===p){b=p+"/main";break}if(o.name===p){b=o.location?o.location+"/":"",b+=p+"/"+(u||o.main||"main");break}}return f.hasOwnProperty(t)&&(h={name:f[t].exports||f[t].name||t,deps:f[t].imports||f[t].deps||[]}),i=s.useBase(b)?i:g.baseUrl,a=new e(e.addExtension(b,"js"),i),{name:t,deps:[],file:a,urlArgs:c,shim:h,plugins:d}},s.useBase=function(e){return"."===e[0]&&("/"===e[1]||"."===e[1])||s.hasProtocol(e)},s.hasProtocol=function(s){return/^(?:(https?|file)(:\/\/\/?))/g.test(s)},s.File=e,s.URL=t,module.exports=s}();
