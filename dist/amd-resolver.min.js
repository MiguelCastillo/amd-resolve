...
!function(){"use strict";function e(e){this.settings=e||{};var s=this.settings.baseUrl||(this.settings.baseUrl="");s&&"/"!==s[s.length-1]&&(this.settings.baseUrl=s+"/")}var s=require("./file"),t=require("./url");e.prototype.resolve=function(s,t){return e.useBase(s)?this.fromBase(s,t):this.fromResolver(s)},e.prototype.fromBase=function(e,t){var r=this.settings,i=r.urlArgs,n=new s(s.addExtension(e,"js"),t);return{name:e,deps:[],file:n,urlArgs:i}},e.prototype.fromResolver=function(e){var t,r,i,n,o,a,l,p=this.settings,u=p.baseUrl,f=p.urlArgs,h=p.shim||{},g=p.packages||[],m=p.paths&&p.paths[e]||e,c=e.split("!");for(e=c.pop(),n=e.replace(/[\/\\]+/g,"/").split("/"),o=n.shift(),a=n.join("/"),t=0,r=g.length;r>t;t++){if(i=g[t],i===o){m=o+"/main";break}if(i.name===o){m=i.location?i.location+"/":"",m+=o+"/"+(a||i.main||"main");break}}h.hasOwnProperty(e)&&(l={name:h[e].exports||h[e].name||e,deps:h[e].imports||h[e].deps||[]});var d=new s(s.addExtension(m,"js"),u);return{name:e,deps:[],file:d,urlArgs:f,shim:l,plugins:c}},e.useBase=function(s){return"."===s[0]&&("/"===s[1]||"."===s[1])||e.hasProtocol(s)},e.hasProtocol=function(e){return/^(?:(https?|file)(:\/\/\/?))/g.test(e)},e.File=s,e.URL=t,module.exports=e}();
