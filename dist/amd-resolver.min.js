...
!function(){"use strict";function e(e){this.settings=e||{};var s=this.settings.baseUrl||(this.settings.baseUrl="");s&&"/"!==s[s.length-1]&&(this.settings.baseUrl=s+"/")}var s=require("./file"),t=require("./url");e.prototype.resolve=function(t,i){var r,n,a,o,l,p,u,h,g=this.settings,c=g.urlArgs,f=g.shim||{},m=g.packages||[],b=g.paths||{},d=b[t],U=t.split("!");for(t=U.pop(),l=t.replace(/[\/\\]+/g,"/").split("/"),p=l.shift(),u=l.join("/"),r=0,n=m.length;n>r;r++){if(o=m[r],o===p){d=p+"/main";break}if(o.name===p){d=o.location?o.location+"/":"",d+=p+"/"+(u||o.main||"main");break}}return f.hasOwnProperty(t)&&(h={name:f[t].exports||f[t].name||t,deps:f[t].imports||f[t].deps||[]}),d||(d=t),i=e.useBase(d)&&i?i:g.baseUrl,a=new s(s.addExtension(d,"js"),i),{name:t,deps:[],file:a,urlArgs:c,shim:h,plugins:U}},e.useBase=function(s){return"."===s[0]&&("/"===s[1]||"."===s[1]&&"/"===s[2])||e.hasProtocol(s)},e.hasProtocol=function(e){return/^(?:(https?|file)(:\/\/\/?))/g.test(e)},e.File=s,e.URL=t,module.exports=e}();
